    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicoID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_medic', to='medicos.medicos')),
                ('servicioID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicos.servicios')),
                ('userID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
